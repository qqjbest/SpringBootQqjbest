...
public class PasswordHelper
{
    ...
    public boolean checkPassword(Admin user, String inputPassword)
    {
        String hashPassword = new SimpleHash(algorithmName, inputPassword, ByteSource.Util.bytes(user.getCredentialsSalt()), hashIterations).toHex();
